...
do
    if [[ $stage -eq 0 ]]; then
        ...
        CUDA_VISIBLE_DEVICES=0,1,2,3 swift sft \
            ...
            --output_dir ./output/${model_type}/${puzzle_id}/finetune-models/decomposition-finetune-subimage-score-shift-${step}/v0-${date}-question-split-0 \
            --logging_dir ./output/${model_type}/${puzzle_id}/finetune-models/decomposition-finetune-subimage-score-shift-${step}/v0-${date}-question-split-0/runs \
        ...
        CUDA_VISIBLE_DEVICES=0,1,2,3 swift sft \
            ...
            --eval_batch_size '1' \
            --add_output_dir_suffix False \
            --output_dir ./output/${model_type}/${puzzle_id}/finetune-models/decomposition-finetune-subimage-score-shift-${step}/v0-${date}-question-split-${stage} \
            --logging_dir ./output/${model_type}/${puzzle_id}/finetune-models/decomposition-finetune-subimage-score-shift-${step}/v0-${date}-question-split-${stage}/runs \
            --ignore_args_error True
    fi
    sleep 30
done