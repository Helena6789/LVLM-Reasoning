...
base_path = "./data/new_71_99/"

file_list={
    "18":"./data/18/question_split/finetune-inference/puzzle_18_test_0.json",
}


for file in file_list:
    print(f"Begin puzzle {file}:")
    json_file_path = base_path+file_list[file]
    with open(json_file_path, 'r', encoding='utf-8') as f:
        data = json.load(f)
    csv_file_path ="./data/finetune_dataset/internvl2_sft_preidct_"+file+".csv"
    # csv_file_path ="./data/new_71_99/internvl2_99_sft_preidct_"+file+".csv"
    ...
    print(f"Finished {file} and results saved to csv {csv_file_path}")
