...
#internvl2
model_path="/home/yyf/models/internvl2-8b"
...
def get_final_msg(messages,generated_text):
      ...
      assistant_msg={"role":"assistant","content":generated_text}
      messages.append(assistant_msg)
      final_query={"role":"user","content":"最终的答案是什么，只需要回答'A','B','C','D','E'这五个选项中的一个，不要回答其他任何答案"}
      # final_query={"role":"user","content":"最终的答案是什么，是否可以是'{true_answer}'，是的话返回'1'，不是的话返回'0'，不要有其他返回值。"}
