...
base_path = "./data/llava_data/new_71_99/"
...
for file in file_list:
    ...
    with open(json_file_path, 'r', encoding='utf-8') as f:
        data = json.load(f)
    csv_file_path ="./data/llava_data/finetune_dataset/internvl2_sft_preidct_"+file+".csv"
    # csv_file_path ="./data/llava_data/new_71_99/internvl2_99_sft_preidct_"+file+".csv"
